      ...
      {isLoading ? (
        ...
        <>
          <KanbanColumn
            ...
            setIsDragSource={(isSrc) => setDraggedSource(isSrc ? COLUMN_KEY_TODO : null)}
            setIsDragTarget={(isTgt) => setDraggedTarget(isTgt ? COLUMN_KEY_TODO : null)}
            onDrop={handleDrop}
            canAddNew
          ...
          <KanbanColumn
            ...
            setDraggedItem={setDraggedItem}
            setIsDragSource={(isSrc) => setDraggedSource(isSrc ? COLUMN_KEY_ONGOING : null)}
            setIsDragTarget={(isTgt) => setDraggedTarget(isTgt ? COLUMN_KEY_ONGOING : null)}
            onDrop={handleDrop}
          ...
          <KanbanColumn
            ...
            cardList={doneList}
            setDraggedItem={setDraggedItem}
            setIsDragSource={(isSrc) => setDraggedSource(isSrc ? COLUMN_KEY_DONE : null)}
            setIsDragTarget={(isTgt) => setDraggedTarget(isTgt ? COLUMN_KEY_DONE : null)}
            onDrop={handleDrop}
